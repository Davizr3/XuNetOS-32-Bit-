...
{
	cons_putstr0(cons, "\n");
	cons_putstr0(cons, "XuNet_OS v4.1   <shell 5.2>  GUI 2.2\n");
	cons_putstr0(cons, "Copyright (C) 2019 Inbora Studio\n");
...
int cmd_app(struct CONSOLE *cons, int *fat, char *cmdline)
{
	...
	if (finfo != 0) {
		...
		// -----------------------------------------------
		if (appsiz >= 36 && strncmp(p + 4, "XuNet��", 4) == 0 && *p == 0x00) 
		// -----------------------------------------------
		{
			segsiz = *((int *) (p + 0x0000));
			esp    = *((int *) (p + 0x000c));
			...
			cons_putstr0(cons, "XuNet OS Ӧ�ó����ļ��򿪴��XuNet߲��Ǳ�׼��XuNet os��ִ���ļ���\n�����޷��ڱ������������ !\n.HEL application program Opening Error.\n");
		}
